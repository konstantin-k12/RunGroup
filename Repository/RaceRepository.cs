...
namespace RunGroupWebApp.Repository
{
    ...
    {
        private readonly ApplicationDbContext _context; // поле содедержащее бд, DI.
        ...
        {
            // важный момент: включить навигац. свойство Address, иначе не будет отображаться, будет исключение
